    ...
    "CBS6": {
        ...
        "expected_events": {
            ...
            "Aperiodic 01": [
                ...
                (46, TraceEvent.TRACE_BUDGET_RUN_OUT),
                (46, TraceEvent.TRACE_DONE),
                (46, TraceEvent.TRACE_SWITCH_OUT),
            ],
            "Aperiodic 02": [
    ...
    "CBS7": {
        ...
        "expected_events": {
            ...
            "Periodic 02": [
                ...
                (66, TraceEvent.TRACE_SWITCH_OUT),
                (66, TraceEvent.TRACE_DONE),
            ],
            "Aperiodic 01": [
                (0, TraceEvent.TRACE_RELEASE),
                (7, TraceEvent.TRACE_SWITCH_IN),
                ...
                (57, TraceEvent.TRACE_BUDGET_RUN_OUT),
    ...
    "CBS14": {
        ...
        "expected_events": {
            "Periodic 01": [
                ...
                (7, TraceEvent.TRACE_RELEASE),
                (12, TraceEvent.TRACE_SWITCH_IN),
                (14, TraceEvent.TRACE_DEADLINE_MISS),
            ],
            "Aperiodic 01": [
                (0, TraceEvent.TRACE_RELEASE),
                (4, TraceEvent.TRACE_SWITCH_IN),
    ...
    "CBS17": {
        ...
        "expected_events": {
            "Periodic 01": [
                ...
                (28, TraceEvent.TRACE_RELEASE),
                (32, TraceEvent.TRACE_SWITCH_IN),
                (35, TraceEvent.TRACE_DEADLINE_MISS),
            ],
            "Aperiodic 01": [
                (0, TraceEvent.TRACE_RELEASE),
                (4, TraceEvent.TRACE_SWITCH_IN),
