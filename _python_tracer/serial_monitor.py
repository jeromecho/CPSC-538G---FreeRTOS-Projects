    ...
    try:
        ...
        for _, row in df_sorted.iterrows():
            ...
            if event == TraceEvent.TRACE_SWITCH_IN:
                ...
                if active_task == t_name and current_segment_start is not None and current_in_row is not None:
                    exec_bars.append(
                        {
                            "TASK_NAME": t_name,
                            ...
                            "TASK_STATE": TASK_STATES.get(current_in_row["TASK_STATE"], "Unknown"),
        ...
        if active_task and current_segment_start is not None and current_in_row is not None:
