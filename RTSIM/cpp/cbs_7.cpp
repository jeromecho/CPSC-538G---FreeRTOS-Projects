...
int main()
{
    ...
    {
        // CBS Test 1
        TextTrace ttrace("trace_cbs7.txt");
        ...
        // Periodic Tasks:
        PeriodicTask p1(12, 12, 0, "P1");
        p1.insertCode("fixed(4);");
        p1.setAbort(true);
        kern.addTask(p1);

        PeriodicTask p2(9, 9, 0, "P2");
        ...
        CBServer serv1(2, 16, 16, false, "server1", "FIFOSched");
        CBServer serv2(4, 20, 20, false, "server2", "FIFOSched");
        ...
        Task a1_1(nullptr, 1000, 0, "CBS1_a3_1");
        a1_1.insertCode("fixed(3);");
        a1_1.setAbort(false);
        a1_1.activate();
        serv1.addTask(a1_1);

        Task a2_1(nullptr, 1000, 0, "CBS1_a4_1");
        a2_1.insertCode("fixed(4);");
        a2_1.setAbort(false);
        a2_1.activate(20);
        serv1.addTask(a2_1);

        Task a3_1(nullptr, 1000, 0, "CBS1_a1_1");
        a3_1.insertCode("fixed(1);");
        a3_1.setAbort(false);
        a3_1.activate(40);
        serv1.addTask(a3_1);

        Task a1_2(nullptr, 1000, 0, "CBS2_a3_1");
        a1_2.insertCode("fixed(3);");
        a1_2.setAbort(false);
        a1_2.activate();
        serv2.addTask(a1_2);

        Task a2_2(nullptr, 1000, 0, "CBS2_a4_1");
