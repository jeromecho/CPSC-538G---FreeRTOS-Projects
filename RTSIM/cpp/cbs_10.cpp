...
int main()
{
    ...
    {
        // CBS Test 1
        TextTrace ttrace("trace_cbs10.txt");
        ...
        */
        ...
        CBServer serv2(2, 8, 8, false, "server2", "FIFOSched");
        CBServer serv3(3, 8, 8, false, "server3", "FIFOSched");
        ...
        Task a3_1(nullptr, 100, 0, "CBS1_a2_1");
        ...
        Task a1_3(nullptr, 100, 0, "CBS3_a3_1");
        a1_3.insertCode("fixed(3);");
        a1_3.setAbort(false);
        a1_3.activate();
        serv3.addTask(a1_3);

        Task a2_3(nullptr, 100, 0, "CBS3_a4_1");
        a2_3.insertCode("fixed(4);");
        a2_3.setAbort(false);
        a2_3.activate(20);
        serv3.addTask(a2_3);

        Task a3_3(nullptr, 100, 0, "CBS3_a2_1");
